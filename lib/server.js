...
server.init = () => {
    ...
    server.httpServer.listen(config.httpPort, () => {
        console.log(
            '\x1b[36m%s\x1b[0m \x1b[33m%s\x1b[0m \x1b[36m%s\x1b[0m \x1b[33m%s\x1b[0m \x1b[36m%s\x1b[0m',
             `Server is listening on HTTP port:`,
             config.httpPort,
             'in',
    ...
    server.httpsServer.listen(config.httpsPort, () => {
        console.log(
            '\x1b[35m%s\x1b[0m \x1b[33m%s\x1b[0m \x1b[35m%s\x1b[0m \x1b[33m%s\x1b[0m \x1b[35m%s\x1b[0m',
             `Server is listening on HTTP port:`,
             config.httpsPort,
             'in',
             config.envName.toUpperCase(),
